...
<div class="pub-list">
  <article class="pub-card">
    <div class="pub-media">
      <img src="{{ 'img/publications/comming_soon.jpg' | relative_url }}" alt="3DGP">
    </div>
    <div class="pub-body">
      <h3 class="pub-title">Visuomotor Policy Learning with Gaussian Splatting</h3>
      <p class="pub-abstract">More details coming soon ...</p>
    </div>
  </article>
</div>
